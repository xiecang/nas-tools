...
RUN apk add --no-cache --virtual .build-deps \
    ...
    libxml2-dev \
    libxslt-dev \
    && apk add --no-cache $(echo $(wget --no-check-certificate -qO- https://raw.githubusercontent.com/120318/nas-tools/dev/package_list.txt)) \
    ...
    && pip install cython \
    && pip install -r https://raw.githubusercontent.com/120318/nas-tools/dev/requirements.txt \
